...
construction_script="examples/evaluate_lightmem_on_locomo/run_construction.sh"
search_script="examples/evaluate_lightmem_on_locomo/run_search.sh"
evaluation_script="examples/evaluate_lightmem_on_locomo/run_evaluation.sh"

log_dir="lightmem_logs"
pid_file="${log_dir}/process_1.pid"
log_file="${log_dir}/process_1.log"
stage1_output="lightmem_output/LoCoMo_stage_1.json"
